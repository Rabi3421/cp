      ...
      <div className='space-y-6'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
          ...
          <div className='bg-white dark:bg-black rounded-2xl shadow-lg p-4 border border-gray-200 dark:border-gray-800'>
            ...
            <p className='text-2xl font-bold text-green-500'>1,180</p>
          </div>
          <div className='bg-white dark:bg-black rounded-2xl shadow-lg p-4 border border-gray-200 dark:border-gray-800'>
            <p className='text-gray-600 dark:text-gray-400 text-sm mb-1'>
              Admins
                  ...
                  <tr
                    ...
                    <td className='px-6 py-4 whitespace-nowrap'>
                      <select
                        ...
                        className='px-3 py-1 bg-primary/10 text-primary text-xs font-medium rounded-full border-0 focus:ring-2 focus:ring-primary capitalize'>
